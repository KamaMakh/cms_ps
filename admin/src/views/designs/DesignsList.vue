<template>
  <div class="animated fadeIn page-design-list">
      <b-card class="bg-secondary" v-for="design in list">
        <div slot="header">
          {{ design.name }}
          <div class="card-header-actions">
            <router-link :to="{ name: 'DesignEdit', params: { id: design.id }}" class="card-header-action btn-setting"><i class="icon-settings"></i></router-link>
